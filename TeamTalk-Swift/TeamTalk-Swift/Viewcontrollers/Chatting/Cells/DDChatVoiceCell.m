...
- (void)setContent:(MTTMessageEntity *)content
{
    ...
    if ([content.info[MTTMessageEntity.DDVOICE_PLAYED] intValue])
    {
    ...
    float voiceLength = [content.info[MTTMessageEntity.VOICE_LENGTH] floatValue];
    ...
    NSUInteger timeLength = [content.info[MTTMessageEntity.VOICE_LENGTH] longValue];
    NSString* lengthString = [NSString stringWithFormat:@"%ld\"",(unsigned long)timeLength];
