...
- (void)layoutSubviews
{
    ...
    //考慮到下拉首先看到的應該是“下拉刷新” 這個提示，把MJ原生的的設置對調。
    self.statusLabel.frame = CGRectMake(lastUpdateX, lastUpdateY, lastUpdateWidth, lastUpdateHeight);
    self.lastUpdateTimeLabel.frame = CGRectMake(statusX, statusY, statusWidth, statusHeight);
}
