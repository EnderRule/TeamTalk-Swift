...
- (NSArray *)loadChartletEmoticonCatalog{
    NSURL *url = [[NSBundle mainBundle] URLForResource:NIMKit_EmojiBundleName
                                         withExtension:nil];
                             ...
                             emoticons:(NSArray *)emoticonsArray
{
    ...
    NSString *iconNamePrefix = [NIMKit_EmojiBundleName stringByAppendingPathComponent:NIMKit_EmojiPath];
    ...
    for (NSDictionary *emoticonDict in emoticonsArray) {
        ...
        NSString *imageNamePrefix = [NIMKit_EmojiBundleName stringByAppendingPathComponent:NIMKit_EmojiPath];
